...
function job_setup()
	...
	init_job_states({"Capacity","AutoRuneMode","AutoTrustMode","AutoWSMode","AutoJumpMode","AutoShadowMode","AutoFoodMode","AutoStunMode","AutoDefenseMode",},{"AutoBuffMode","AutoSambaMode","Weapons","OffenseMode","WeaponskillMode","Stance","IdleMode","Passive","RuneElement","TreasureMode",})
...
function check_jump()
    if state.AutoJumpMode.value and player.status == 'Engaged' and player.tp < 701 then
